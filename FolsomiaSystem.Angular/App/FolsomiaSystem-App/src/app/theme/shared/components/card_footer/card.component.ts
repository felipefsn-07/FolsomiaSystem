...
export class CardComponent implements OnInit {
  ...
  @Input() hidRemove: boolean;
  @Input() hidEdit: boolean;
  ...
  constructor(/*animationService: AnimationService,*/ config: NgbDropdownConfig) {
    ...
    this.collapsedIcon = 'icon-minimize-2';
  ...
  public fullCardToggle(element: HTMLElement, animation: string, status: boolean) {
    ...
    this.fullIcon = this.cardClass === 'full-card' ? 'icon-maximize' : 'icon-minimize-2';
  ...
  collapsedCardToggle() {
    ...
    this.collapsedIcon = this.collapsedCard === 'collapsed' ? 'icon-maximize-2' : 'icon-minimize-2';
  }
